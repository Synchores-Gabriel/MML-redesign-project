    ...
    >
      <div className="w-full max-w-screen-2xl mx-auto flex items-center justify-between mml-res-container">
        ...
        <Link href="/" className="flex items-center gap-3 md:gap-4 group mml-global-header__logo shrink-0">
          ...
          <span
            className={cn(
              "font-serif text-[11px] md:text-sm leading-snug tracking-wider transition-colors duration-400 uppercase font-semibold mml-global-header__logo-text",
              logoColor
            )}
        ...
        {/* ═══════ Mobile menu button ═══════ */}
        <button className={cn("lg:hidden p-2 transition-colors", mobileIconColor)}>
