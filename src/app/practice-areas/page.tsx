...
const practices = [
  {
    ...
    details: "We advise our corporate clients on, and help them manage, compliance and good governance. In this connection, lawyers of our firm are able to serve as corporate secretaries, assisting the client in managing director and stockholder meetings, share issuances and transfers, record keeping, and complying with reporting requirements imposed by such agencies as the Securities and Exchange Commission, the Department of Trade and Industry, the Board of Investments, and the Philippine Stock Exchange.",
  ...
  },
  {
    ...
    details: "We help our clients comply with all their tax-related requirements – rulings, treaty relief applications, tax audits, tax assessments and refund claims. Our customs practice group handles customs duty assessments, customs duty refund claim and anti-dumping controversies. We have a developed tax litigation practice and have won precedent-setting cases for our clients. We provide specialized advice on estate planning, and employee compensation and retirement benefits.",
